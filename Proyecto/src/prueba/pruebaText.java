 ...
 * class construction.
 */
public class pruebaText extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public pruebaText(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public pruebaText(String text, JTextComponent component, Show show) {
